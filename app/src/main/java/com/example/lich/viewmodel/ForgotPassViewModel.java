...
public class ForgotPassViewModel extends ViewModel {
    private MutableLiveData<Boolean> isCheckCodeStudent = new MutableLiveData<>();

    private LinearLayout btnSend;
    private TextView txtMessage;


    public MutableLiveData<Boolean> getIsCheckCodeStudent() {
        return isCheckCodeStudent;
    }

    public void checkCodeStudent(String codeStudent, Context context) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(WSConfig.Base_Log)
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        BaseDataService service = retrofit.create(BaseDataService.class);
        Call<StatusResponse> callApi = service.checkCodeStudent(codeStudent);
        ...
        callApi.enqueue(new Callback<StatusResponse>() {
            ...
            public void onResponse(Call<StatusResponse> call, Response<StatusResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    isCheckCodeStudent.setValue(true);
                    dialog.dismiss();
                } else {
                    ...
                    dialog.dismiss();
                    isCheckCodeStudent.setValue(false);
                }
            }
